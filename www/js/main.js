...
function MyApplication() {
    ...
    this.about = function() {
        $("#aboutContent").html("<h1>STM App</h1><div>Aplicación de la empresa STM para la gestión y mantenimiento de las infraestructuras. Para mas información, visitar su web: <a href='#' id='externalLink' target='_blank' rel='https://www.stm.com'>https://www.stm.com</a></div><br/><div><b>Dispositivo móvil: </b>" + window.device.model + "(" + window.device.platform + ": " + window.device.version + ")</div><div><b>Conexión: </b>" + states[navigator.connection.type] + "</div>");
